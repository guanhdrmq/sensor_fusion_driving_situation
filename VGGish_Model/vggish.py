...
import VGGish_Model.vggish_params as params

# weight path
WEIGHTS_PATH = '/home/brain/Documents/git/VGGish_Model/vggish_audioset_weights_without_fc2.h5'
...
def VGGish(load_weights=True, weights='audioset',
    ...
    '''
    An implementation of the VGGish_Model architecture.
    ...
    if include_top:
        ...
        x = Dense(512, activation='relu', name='vggish_fc1/fc1_1')(x)
        x = Dense(512, activation='relu', name='vggish_fc1/fc1_2')(x)
